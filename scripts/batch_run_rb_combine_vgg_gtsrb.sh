...
python main_parallel.py --config ./conf/rb_gtsrb_vggsm_static_dirichlet.yaml --attack_type blend --tss_statistical_reject 1
python main_parallel.py --config ./conf/rb_gtsrb_vggsm_static_dirichlet.yaml --attack_type blend --mkrum
python main_parallel.py --config ./conf/rb_gtsrb_vggsm_static_dirichlet.yaml --attack_type blend --rlr
python main_parallel.py --config ./conf/rb_gtsrb_vggsm_static_dirichlet.yaml --attack_type blend --tracer
# python main_parallel.py --config ./conf/rb_gtsrb_vggsm_static_dirichlet.yaml --attack_type blend --flame